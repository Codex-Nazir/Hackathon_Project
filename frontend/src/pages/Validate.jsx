      ...
      {loading && (
        <div className="mt-12 text-center">
          <div className="flex justify-center gap-2 mb-4">
            <motion.div animate={{ scale: [1, 1.5, 1] }} transition={{ repeat: Infinity, duration: 1 }} className="w-3 h-3 bg-cyan-500 rounded-full" />
            <motion.div animate={{ scale: [1, 1.5, 1] }} transition={{ repeat: Infinity, duration: 1, delay: 0.2 }} className="w-3 h-3 bg-cyan-500 rounded-full" />
            <motion.div animate={{ scale: [1, 1.5, 1] }} transition={{ repeat: Infinity, duration: 1, delay: 0.4 }} className="w-3 h-3 bg-cyan-500 rounded-full" />
          </div>
          <p className="text-cyan-400 font-mono animate-pulse uppercase tracking-widest text-sm">
            Scanning pixels... Extracting metadata... Consulting LLM...
          </p>
        </div>
      )}
    </div>
